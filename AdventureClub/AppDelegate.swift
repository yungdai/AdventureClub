...
//  AdventureClub
//
//  Created by Yung Dai on 2015-08-29.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("J8KXsT6UdHeZ8gZoRJ83ZtX4JDZdsHf7KPKMRs4Y", clientKey: "BWAoMk4Cqtw1V1saOsFQvrgi290SFFMcSHQA35r3")
        //
        ...
        if PFUser.currentUser()?.sessionToken != nil {
            print("Your session token is valid", terminator: "")
            ...
            let revealVC = storyBoard.instantiateViewControllerWithIdentifier("MainApp") as UIViewController
